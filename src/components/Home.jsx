    ...
    document.addEventListener('DOMContentLoaded',function(event){
      ...
      const typeWriter = (text, i, fnCallback) => {
        ...
        if (i < (text.length)) {
          ...
          if (document.querySelector(".homepage-header-title").innerHTML)
          document.querySelector(".homepage-header-title").innerHTML = text.substring(0, i+1) +'<span aria-hidden="true"></span>';
  ...
  return (
    <div className="Home">
      <div className="header">
        ...
        <h1 className="homepage-header-title">Share your kitchen secrets</h1>
      </div>
    </div>
  );
}
